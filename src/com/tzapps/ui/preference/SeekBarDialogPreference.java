...
public class SeekBarDialogPreference extends DialogPreference
{
    ...
    public SeekBarDialogPreference(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            setMinProgress(a.getInteger(R.styleable.SeekBarDialogPreference_progressMin, DEFAULT_MIN_PROGRESS));
            setMaxProgress(a.getInteger(R.styleable.SeekBarDialogPreference_progressMax, DEFAULT_MAX_PROGRESS));
            setStep(a.getInteger(R.styleable.SeekBarDialogPreference_progressStep, DEFAULT_STEP));
    ...
    protected void onBindDialogView(View view)
    {
        ...
        mSeekBar.incrementProgressBy(mStep);
    }
